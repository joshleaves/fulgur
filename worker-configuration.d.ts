/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 650bfaae9edcc28fe67192e5e7037c10)
// Runtime types generated with workerd@1.20260828.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	PUBLISH_TOKEN_FOO: string;
	PUBLISH_TOKEN_BAR: string;
	PUBLISH_COORDINATOR: DurableObjectNamespace<import("./src/index").PublishCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PublishCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLISH_TOKEN_FOO" | "PUBLISH_TOKEN_BAR">> {}
}
